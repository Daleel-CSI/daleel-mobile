...
class DiscoverScreen extends StatefulWidget {
  ...
  const DiscoverScreen({super.key, this.userName});
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) => CategoryServicesScreen(
              ...
              categoryIcon: cat.iconPath.isNotEmpty ? cat.iconPath : '',
                ...
                child: cat.iconPath.isNotEmpty
                    ? SvgPicture.asset(
                        ...
                        placeholderBuilder: (context) => const Icon(
                            Icons.category, size: 32, color: Color(0xFF379777)),
                      )
                    : const Icon(Icons.category, size: 32, color: Color(0xFF379777)),
              ),
            ),
